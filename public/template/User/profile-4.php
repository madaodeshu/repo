...
<body class="hold-transition skin-blue-light hidden-sidebar-mini sidebar-collapse">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header" style="background:#fff; padding:15px 0px;">
      <h1 style="text-align:center;">Profile</h1>
      <h5 class="hidden-md hidden-lg" style="text-align:center;">
        <a href="kat-kangenkaterk8.com">
          <i class="fa fa-home" style="font-size:15px;color:#333333;"><b>Kat-KangenWaterK8.com</b></i>
        </a>
      </h5>

      <ol class="breadcrumb hidden-sm hidden-xs"  style="background:#fff;">
        <li><a href="kat-kangenkaterk8.com"><i class="fa fa-home" style="font-size:15px;"><b>Kat-KangenWaterK8.com</b></i></a></li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <p class="text-muted text-center">Bidang User</p>

              <a href="Profile Sunting.html" class="btn btn-primary btn-block"><b>Sunting Profile</b></a>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-7">
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content" style="border-top:5px solid #ecf0f5;" >
              ...
              <div class="arc-box" style="margin-bottom:30px;padding:10px 0px; text-align:center;border:3px solid #3c8dbc;">
              ...
              <form class="box-body collapse collapseable" id="collapse-post2" style="border:1px solid #ecf0f5;">
                  <div class="form-group ">
                      ...
                      <div class="col-md-12"  style="margin:10px 0px;">
                          <div class="pull-left btn btn-default btn-file">
                            <i class="fa fa-image" style="border:1px solid grey;"></i>&nbsp;&nbsp;Add Pictures
        ...
        <div class="col-md-2 hidden-sm hidden-xs">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title" ><b>Aktivitas</b></h3>
